...
export const shortcutKeysGroups: ShortcutKeysGroup[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      "setSelectedEdgesToDouble",
      "setSelectedEdgesArrowDefault",
      "setSelectedEdgesArrowHollowTriangle",
      "setSelectedEdgesArrowFilledTriangle",
      "setSelectedEdgesArrowHollowDiamond",
      "setSelectedEdgesArrowFilledDiamond",
      "switchEdgeToUndirectedEdge",
      "switchEdgeToArcEdge",
      "switchUndirectedEdgeToEdge",
      "setMTUEdgeArrowOuter",
      "setMTUEdgeArrowInner",
      "setMTUEdgeArrowNone",
      "switchMTUEdgeRenderType",
      "resetMTUEdgeEndpointLocations",
      "setSelectedEdgeToRight",
      "setSelectedEdgeToLeft",
      "setSelectedEdgeToUp",
      "setSelectedEdgeToDown",
      "setSelectedEdgeToCenter",
      "setSelectedEdgeSourceConnectLocationUp",
      "setSelectedEdgeSourceConnectLocationDown",
      "setSelectedEdgeSourceConnectLocationLeft",
      "setSelectedEdgeSourceConnectLocationRight",
      "setSelectedEdgeSourceConnectLocationCenter",
      "setSelectedEdgeTargetConnectLocationRight",
      "setSelectedEdgeTargetConnectLocationLeft",
      "setSelectedEdgeTargetConnectLocationUp",
      "setSelectedEdgeTargetConnectLocationDown",
      "setSelectedEdgeTargetConnectLocationCenter",
    ],
  },
  {
    title: "node",
